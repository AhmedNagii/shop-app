  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains("EMAIL_EXISTS")) {
        ...
        errorMassage = "This email address is not valid.";
      } else if (error.toString().contains("WEAK_PASSWOED")) {
        errorMassage = "This Password is too weak.";
      } else if (error.toString().contains("EMAIL_NOT_FOUND")) {
        errorMassage = "This email is not registerd.";
      } else if (error.toString().contains("INVALID_ID_PASSOWRD")) {
        errorMassage = "iNVALID PASSWOED.";
      }
